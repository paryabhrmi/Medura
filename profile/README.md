...
| **[git-for-designers](https://github.com/paryabhrmi/git-for-designers)** | A practice-first Git handbook for product designers — the mental model before the commands. Bilingual, Persian (RTL) and English (LTR), with no build step and no dependencies. |
...
[paryabahrami.ir](https://paryabahrami.ir) &nbsp;·&nbsp; [LinkedIn](https://linkedin.com/in/paryabhrmi) &nbsp;·&nbsp; [@paryabhrmi](https://github.com/paryabhrmi)
